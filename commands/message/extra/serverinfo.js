...
const enabled = client.emoji.tick
    ...
    let d = new client.button().secondary('others', 'Other Info', '<:LinkAdd:1122921615349526589>')
    let ddis = new client.button().secondary('others', 'Other Info', '<:LinkAdd:1122921615349526589>', true)
          ...
          si.addFields([
            {
              ...
              value: `**Name** : ${guild.name} \n**Id** : ${guild.id} \n**Owner <:zz_os:1127227647714398318>** : <@!${guild.ownerId}>\n**Created** : <t:${parseInt(createdTimestamp / 1000)}:R>\n**Members** : ${guild.memberCount}\n**Banned** : ${guild.bans.cache.size}`
            },
            {
              name: '__Extras__',
