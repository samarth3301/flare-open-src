...
module.exports = (client) => {
  client.on('guildCreate', async (guild) => {
    ...
    let own = await guild?.fetchOwner();
            ...
            const emb = new client.emb().desc("Added To A New Server!").setThumbnail(client.user.displayAvatarURL({dynmaic : true})).setTimestamp().setAuthor({name : `Flare` , iconURL : guild.iconURL({dynmaic : true})}).addFields([
              ...
              {name: 'Server Invite', value: "discord.gg/"+ invite.code},
              {
